    ...
    <div className="pt-32 pb-20 px-4 min-h-[85vh] flex items-center justify-center bg-surface-container-low">
      <div className="bg-surface p-8 md:p-10 rounded-3xl shadow-xl w-full max-w-md border border-outline-variant/20">
        <div className="text-center mb-8">
          <h1 className="font-headline-lg text-3xl text-primary font-bold mb-2">Join the Hearth</h1>
          <p className="font-body-md text-on-surface-variant">Create an account to save your favorite orders.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            type="submit" 
            className="w-full bg-primary text-on-primary py-4 rounded-xl font-label-md text-[16px] hover:opacity-90 active:scale-95 transition-all shadow-md mt-2"
          >
            Create Account
          </button>
        </form>
